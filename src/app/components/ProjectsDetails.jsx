          ...
          >
            <figure>
              ...
              <figcaption>
                ...
                <hr />
                <p>
                  Using the Pixabay API, I recreated the replica of the
                  Pinterest homepage.
                </p>
                <label>
                  <img src={require("../../img/tools.svg")} alt="icon" />
                  <p>
                    React JS, Adobe XD, Balsamiq, libraries and Pixabay api.
                  </p>
                </label>
                <a
          ...
          >
            <figure>
              ...
              <figcaption>
                ...
                <hr />
                <p>
                  Library created using Node.js, which reads and analyzes files
                  in Markdown format.
                </p>
                <label>
                  <img src={require("../../img/tools.svg")} alt="icon" />
